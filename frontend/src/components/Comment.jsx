...
const Comment = ({ com, onDeleteComment, onLike }) => {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            try {
                const res = await fetch(`https://mern-blog-digr.onrender.com/api/user/getuser/${com.userid}`);
    ...
    const handleSave = async () => {
        try {
            ...
            const res = await fetch(`https://mern-blog-digr.onrender.com/api/comment/editcomment/${com._id}`, {
                method: 'POST',
                credentials: 'include',
                headers: {
    ...
    const onDelete = async () => {
        try {
            const token = localStorage.getItem("access_token");
            const res = await fetch(`https://mern-blog-digr.onrender.com/api/comment/deletecomment/${com._id}`, {
                method: 'DELETE',
                credentials: 'include',
                headers: {
                    'Authorization': `Bearer ${token}`,
