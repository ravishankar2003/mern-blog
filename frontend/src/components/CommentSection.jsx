...
const CommentSection = ({ postid }) => {
    ...
    useEffect(() => {
        const getComments = async () => {
          try {
            const res = await fetch(`https://mern-blog-digr.onrender.com/api/comment/getcomments/${postid}`);
            if (res.ok) {
    ...
    const handleSubmit = async(e) => {
        ...
        const res = await fetch('https://mern-blog-digr.onrender.com/api/comment/create',{
            method: 'POST',
            credentials: 'include',
            headers: {
    ...
    const handleLike = async (commentId) => {
        try {
          ...
          const token = localStorage.getItem("access_token")
          const res = await fetch(`https://mern-blog-digr.onrender.com/api/comment/likecomment/${commentId}`, {
            method: 'PUT',
            credentials: 'include',
        headers: {
          'Authorization': `Bearer ${token}`,
