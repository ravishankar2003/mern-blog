    ...
    const [formdata, setformdata] = useState({
      ...
      const handleSubmit = async (event) => {
        ...
        try {
          ...
          const res = await fetch('https://mern-blog-digr.onrender.com/api/user/updateprofile', {
            method: 'POST',
            credentials: 'include',
            headers: { 
      ...
      const handledeleteaccount = async (event) => {
        ...
        setmsg(null)
        try {
          const res = await fetch('https://mern-blog-digr.onrender.com/api/user/deleteprofile', {
            method: 'DELETE',
            credentials: 'include',
            body: formdata,
          });
