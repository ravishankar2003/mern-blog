...
const PostPage = () => {
    ...
    useEffect(() => {
        const fetchRecentPosts = async () => {
            try {
                const res = await fetch(`https://https://mern-blog-digr.onrender.com/api/post/getposts?limit=4`);
    ...
    useEffect(() => {
        const fetchPost = async () => {
            try {
                const res = await fetch(`https://https://mern-blog-digr.onrender.com/api/post/getposts?slug=${postslug}`);
                const data = await res.json();
                if (res.ok) {
