...
const UpdatePost = () => {
  ...
  useEffect(() => {
    const fetchPostInfo = async () => {
      try {
        const res = await fetch(`https://mern-blog-digr.onrender.com/api/post/getposts?postid=${postid}`);
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const res = await fetch(`https://mern-blog-digr.onrender.com/api/post/updatepost/${postid}/${currentuser._id}`, {
        method: 'POST',
        credentials: 'include',
        headers: {
